...
process bwa {
  ...
  time params.heavy_job_time
  cpus params.heavy_job_cpus
  memory params.heavy_job_mem
  queue params.heavy_job_queue
...
process get_coverage_of_markers {
  ...
  conda 'bioconda::bedtools'
    ...
    script:
    """
      samtools view -b ${sample_id}.bam MN908947.3 > ${sample_id}_f.bam \
          && bedtools coverage -sorted -a ${params.markers_bed} -b ${sample_id}_f.bam > ./${sample_id}_coverage.bed
    """
}
